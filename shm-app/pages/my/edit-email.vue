<template>
	<view>
		...
		<!--提示栏-->
		<view class="text-black text-center margin-top padding">完成邮箱验证进行换绑邮箱</view>
		...
		<view class="text-sm text-gray padding-sm">验证码将会发送到您的邮箱中~</view>
		
		<view class="bg-white wecanui-footer-fixed foot-pb">
			<view class="flex flex-direction padding-sm">
				<button class="cu-btn bg-red" @tap="submit">换绑邮箱</button>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			checking() {
				uni.hideKeyboard()
				if(!(/^\w+@[\da-z\.-]+\.([a-z]{2,6}|[\u2E80-\u9FFF]{2,3})$/.test(this.email))){ 
